...
export const INITIAL_APPS: AppInfo[] = [
  {
    ...
    features: [
      'Kufungua PDF haraka',
      'Kusoma nyaraka mbalimbali',
      'Kuhariri nyaraka kwa urahisi',
      'Kufanya kazi na nyaraka za office',
      'Kiolesura rafiki kwa simu za mkononi',
    ],
    testingUrl: 'https://play.google.com/apps/testing/co.pdfoffice.ap',
    accentColor: '#EF4444', // Red/Coral
    badgeBg: 'bg-red-500/10 text-red-400 border-red-500/20',
    badgeBorder: 'group-hover:border-red-500/40',
  ...
  },
  {
    ...
    features: [
      'Screen recording bila vikwazo',
      'Kutengeneza video zenye sauti safi',
      'Kurekodi tutorials na masomo',
      'Kurekodi gameplay za michezo',
      'Face camera / camera overlay inayofanya kazi bila kukwama',
      'Creating instructional videos za kuelimisha',
    ],
    testingUrl: 'https://play.google.com/apps/testing/co.freescreenrecorder.ap',
    accentColor: '#10B981', // Emerald
    badgeBg: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
    badgeBorder: 'group-hover:border-emerald-500/40',
  ...
  },
  {
    ...
    features: [
      'Kuangalia nafasi mpya za kazi kila siku',
      'Kutafuta fursa kulingana na aina na taaluma',
      'Kusoma maelezo na vigezo vya ajira',
      'Kufuatilia fursa mpya kwa urahisi na arifa',
      'Kuhifadhi kazi unazopenda kusoma baadaye',
    ],
    testingUrl: 'https://play.google.com/apps/testing/co.jobsreport.ap',
    accentColor: '#F59E0B', // Amber
    badgeBg: 'bg-amber-500/10 text-amber-400 border-amber-500/20',
    badgeBorder: 'group-hover:border-amber-500/40',
  ...
  },
  {
    ...
    features: [
      'Kusikiliza muziki ulio kwenye simu',
      'Kuonyesha Album artwork zenye kuvutia',
      'Kupanga kwa Wasanii (Artists) & Albamu',
      'Kupanga nyimbo, Folders na Playlists zako',
      'Modern music-player interface na kusawazisha sauti (equalizer)',
      'Smooth music playback bila kukatika',
    ],
    testingUrl: 'https://play.google.com/apps/testing/co.musicplay.ap',
    accentColor: '#8B5CF6', // Purple/Violet
    badgeBg: 'bg-purple-500/10 text-purple-400 border-purple-500/20',
    badgeBorder: 'group-hover:border-purple-500/40',
  ...
  },
  {
    ...
    features: [
      'Kupanga mafaili na kumbukumbu ya simu',
      'Kusimamia documents za kazi na shule',
      'Kusimamia picha na video kwa makundi',
      'Kufungua aina mbalimbali za mafaili',
      'Hide/private area for selected files',
      'Kulinda maudhui binafsi kwa nenosiri/PIN',
    ],
    testingUrl: 'https://play.google.com/apps/testing/co.topfilemanager.ap',
    accentColor: '#06B6D4', // Cyan
    badgeBg: 'bg-cyan-500/10 text-cyan-400 border-cyan-500/20',
    badgeBorder: 'group-hover:border-cyan-500/40',
  ...
  },
  {
    ...
    features: [
      'Mahesabu ya haraka ya hisabati na fedha',
      'Private area ya kulinda taarifa binafsi',
      'Kulinda Contacts (Majina ya simu ya siri)',
      'Kuficha Pictures na Videos binafsi',
      'Kulinda Documents na maelezo ya siri',
      'Mwonekano safi wa calculator halisi',
    ],
    testingUrl: 'https://play.google.com/apps/testing/co.intcalculator.ap',
    accentColor: '#3B82F6', // Blue
    badgeBg: 'bg-blue-500/10 text-blue-400 border-blue-500/20',
    badgeBorder: 'group-hover:border-blue-500/40',
